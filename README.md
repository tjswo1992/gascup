...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .start-guide {
    margin:0 auto 12px; max-width:290px; color:#c9dced;
    font-size:13px; line-height:1.5;
  }
  .start-guide b { color:#ef3340; font-weight:1000; }
  .howto-box {
    margin:0 auto 16px; padding:12px 13px; max-width:320px;
    border-radius:14px; text-align:left;
    background:rgba(255,255,255,.055);
    border:1px solid rgba(255,255,255,.09);
  }
  .howto-title {
    margin-bottom:6px; color:#fff; font-size:12px; font-weight:1000;
    letter-spacing:.08em;
  }
  .howto-main { color:#d9e8f3; font-size:12px; line-height:1.45; }
  .howto-rule {
    display:flex; flex-wrap:wrap; gap:6px 10px; margin-top:7px;
    color:#9fb9cc; font-size:11px; line-height:1.4;
  }
  .howto-rule b { color:#ef3340; font-weight:1000; }
  ...
  @media (max-width: 700px) {
    ...
    .start-guide { font-size:12px; margin-bottom:10px; }
    .howto-box { margin-bottom:13px; padding:10px 11px; }
  ...
  @media (max-width: 430px) {
    ...
    .start-guide { font-size:11px; margin-bottom:9px; }
    .howto-box { margin-bottom:11px; padding:9px 10px; }
    .howto-main { font-size:11px; }
    .howto-rule { font-size:10px; }
  }
</style>
</head>
<body>
  ...
  <main class="arena" id="arena">
    ...
    <section class="overlay start-overlay" id="startOverlay">
      <div class="panel start-panel">
        ...
        <p class="start-guide">이름을 입력하고 가스컵 2026 승부차기에 도전하세요.</p>
        <div class="howto-box" aria-label="게임 방법">
          <div class="howto-title">게임 방법</div>
          <div class="howto-main">골대 안 원하는 위치를 <b>터치</b>해 슛하세요.</div>
          <div class="howto-rule"><span><b>3골 성공</b> 시 우승</span><span>3번 실패 시 재도전</span></div>
        </div>
